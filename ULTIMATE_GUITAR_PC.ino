...
YOU CAN USE IT IF YOU WANT TO CALLING THE pinMode FUNCTION OR {PORT} FUNCTION YOU WANT T PROGRAMM IT USING REGISTERS.  
PROGRAMMED USING IO PORTS OF ATmega32U4 CONTROLLER INSTEAD OF THE SLOWER ARDUINO'S digitalRead FUNCTION. 
...
// DECLARE PORTS IN RESPECTIVE REGISTER AS INPUT(0), FOR OUPUT USE(1) | DECLARA AS PORTAS EM SEUS RESPECTIVOS REGISTARDORES COMO ENTRADA(0), PARA SAIDA USE(1)
